    ...
    <div class="buttonns">
        ...
        while ($row = mysqli_fetch_assoc($query)) {
            ...
            <form action="thanks" method="POST">
                ...
                <input type="hidden" name="product" value="<?= $row['pr_title']?>">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="thanks" method="POST">
                        <input  type="text" name="name" class="form-control mb-1"  placeholder="Имя">
                        <input  type="text" name="phone" class="form-control mb-1"  placeholder="Номер">
                        <input type="hidden" name="price" value="<?= $row['pr_price'] ?>">
                        <input type="hidden" name="product" value="<?= $row['pr_title']?>">
                        <input class="btn btn-success w-100" type="submit" value="Купить">
                    </form>
                    <a href="auth"><i class="fas fa-key"></i> Авторизация</a>
                </div>
